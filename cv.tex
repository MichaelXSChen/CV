...
\begin{itemize}
    ...
    \conference{Proceedings of the 28th ACM Symposium on Operating Systems Principles 2021 (\textbf{SOSP '21}, accepted).} \\
    ...
    \conference{The 39th IFIP WG 7.3 International Symposium on Computer Performance, Modeling, Measurements and Evaluation 2021 ({\bf Performance 2021}, accepted).} \\
    ...
    \conference{Proceedings of the European Conference on Computer Systems 2021 (\textbf{EuroSys '21})} \\
    ...
    \conference{Submitted to CoNext '21, under review.} \\
\end{itemize}
